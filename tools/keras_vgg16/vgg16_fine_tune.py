...
# fine-tune a VGG-16 model with the weights from an already trained top layer to classify the data
import os
import h5py
import numpy as np
...
top_model_weights_path = 'weights/bottleneck_fc_model_50.h5'
batch_size = 32

# dimensions of our images (this has to be the same size as the model from vgg-16_keras was trained on!!!!)
