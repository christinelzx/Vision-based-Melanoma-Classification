...
from cleanData import getDataLabels
import numpy as np
import ipdb
...
options.dim = (28,28,3)        # image dimension (resolution_row, resolution_col, number of color channels)
options.preprocess = 'processed'                     # 'processed' for processed set and 'unprocessed' for unprocessed set
options.balanced_train_set = False      # True for balanced set and False for original unbalanced set
options.balanced_test_set = False
...
y_train = labels.train  # get training labels
y_test = labels.test   # get test labels
