...
#		- >> python inventory_tracking.py \Test_Pics\Pair20.1JPG \Test_Pics\Pair20.2JPG     	(if fromDropBox = False)
#
# TODO:
...
disp_time = 3000			# milliseconds to display each picture with missing items for. Set to 0 for keystroke to clear the picture	
